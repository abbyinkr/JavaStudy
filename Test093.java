...
public class Test093
{
	...
	int b = 20;		//동생			//-- 인스턴스 변수(instance 변수)
	...
	static void print()	//형		//-- 클래스 메소드(static 메소드)
	{
		System.out.println("클래스 변수 a   : " + a);
		//System.out.println("인스턴스 변수 b : " + b); //-- 에러 발생
	}

	public static void main(String[] args)	// 형 - 형들끼린 쌍둥이! 동시에 탄생
	{
		System.out.println("main() → 클래스 변수 a : " + Test093.a);
		//-- 클래스 변수에 접근하기 위해서는
		//	 『클래스명.변수명』 의 형태로 접근이 가능하다. -> 선점한 문법 static임
		//--==>> main() → 클래스 변수 a : 10
		...
		// 생성된 인스턴스를 통한 클래스 변수 접근 (생성된 인스턴스를 통해 접근하는것"도" 가능)
