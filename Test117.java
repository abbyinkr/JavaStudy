...
○ 중첩 클래스 개요
   ...
   클래스를 중첩하여 프로램의 구조를 보다 더 간단하고 알아보기 쉽도록
...
class Test
{
	...
	public static class StaticNested
	{
		...
		void write()
		{
			...
			System.out.println("a : " + a); // a는 클래스 변수라 접근가능
			//System.out.println("b : " + b); //-- 에러 발생(컴파일 에러)
			//b는 인스턴스변수, 동생이라 탄생시점 모름
			System.out.println("c : " + c); // write가 태어날때 c도 태어남 접근가능
		}
	}
...
public class Test117
{
	public static void main(String[] args)
	{
	   ...
	   //    단, 위와 같은 방법으로는 객체를 생성해서는 안되고
	   //    클래스 메소드를 호출하거나, 클래스 변수에 접근하는 것과 같은 
	   //    방식을 통해 접근하여 인스턴스를 생성할 수 있도록 처리해야 한다.
