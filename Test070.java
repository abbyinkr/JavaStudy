...
class Rect		// 직사각형 클래스 설계
{
	...
	// 멤버 변수 - 클래스에 소속되어있는 요소로써의 의미 (Rect 클래스에 소속)
	...
	{
		// (가로 + 세로 ) * 2
		return (w + h) * 2;			// return 안하면 연산한값이 지역변수라서 사라져버림!
	}
...
public class Test070		// public 이 붙은 class 명으로 파일 저장!
{
