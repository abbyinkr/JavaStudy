...
○ StringTokenizer 클래스는
   ...
   java.util 패키지의 StringTokenizer를 import를 해야 한다.
...
○ 생성자
   - 원형
   StringTokenzier(String str)
   StringTokenizer(String str, String delim)
   StringTokenzier(String str, String delim, boolean returnDelims)
