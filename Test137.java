...
○ Calendar 클래스 객체(인스턴스)를 생성할 수 있는 방법
   ...
   (※ GregorianCalender : Calendar 클래스의 하위(자식) 클래스)
...
public class Test137
{
	public static void main(String[] args)
	{
		...
		int m = rightNow.get(Calendar.MONTH)+1; // MONTH는 인덱스값을 반환하므로 +1
        ...
        */
		...
		rightNow2.set(2021, 6, 9); // 7월-1 check~!!!
		...
		// 생년월일 세팅
		rightNow2.set(1993, 2, 8); // 1993년 3월 8일
		// 요일 확인
		System.out.println(week2[rightNow2.get(Calendar.DAY_OF_WEEK)-1]);
		//--==>> 월요일
