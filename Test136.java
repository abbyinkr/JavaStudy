...
○ 캐릭터 셋(character Set)
   ...
   - 유니코드(Unicode)
     국제표준으로 제정된 2바이트계의 만국 공통의 
	 국제 문자부호체계(UCS : Universal Code System)를 말한다.
	 ...
	 16비트로 통일하였다. 코드 1문자당 영어는 7비트, 비영어는 8비트,
   ...
   - UTF-8 과 UTF-16
	 ...
	 ·UTF-8(8bit UCS Transformaition Format)
	   웹에서 기본적으로 사용하는 코드.
...
○ 문자 코드의 종류
   ...
   - EUC-KR(MS949)-------------지금 default character set
...
public class Test136
{
	public static void main(String[] args) //throws UnsupportedEncodingException
	{
		...
		try
		{
			...
			// 디폴트 캐릭터 셋(MS949)으로 저장된 바이트 배열을
			// String 객체로 생성
			...
			/*
			※ EUC-KR을 UTF-8 로 변환한다고 위와 같이 코딩을 해버리면
